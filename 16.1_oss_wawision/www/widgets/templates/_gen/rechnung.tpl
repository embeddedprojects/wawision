...
<table width="100%" height="330">
  ...
  <tr><td width="200">Zahlungsstatus:</td><td width="70%">[ZAHLUNGSSTATUS][MSGZAHLUNGSSTATUS]
    </td></tr>
<tr><td></td><td colspan="1">
<table>

<tr><td>Mahnwesen IST:</td><td>
[IST][MSGIST]</td></tr>
<tr><td>IST:</td><td>
[LIVEIST]&nbsp;Skonto gegeben:[SKONTO_GEGEBEN][MSGSKONTO_GEGEBEN]</td></tr>
<tr><td>SOLL:</td><td>[SOLL]</td></tr></table></td></tr>
