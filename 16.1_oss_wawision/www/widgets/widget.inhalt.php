...
{
  private $app;
  function WidgetInhalt($app,$parsetarget)
  {
    $this->app = $app;
    $this->parsetarget = $parsetarget;
    parent::WidgetGenInhalt($app,$parsetarget);
    $this->ExtendsForm();
  }
  ...
  public function Table()
  {
    ...
    AND s.id=g.shop");
    $table->DisplayNew(INHALT, "<a href=\"index.php?module=inhalt&action=edit&id=%value%\"><img border=\"0\" src=\"./themes/[THEME]/images/edit.png\"></a>
