...
<tr><td>Gewicht Paket:</td><td><input type="text" name="kg" size="5" value="2">&nbsp;<i>kg</i></td></tr>
...
<table align="center">
  ...
  <tr><td>Wunsch-Zustelldatum:</td><td><input type="text" size="8" id="zustelldatum" name="zustelldatum" value="[ZUSTELLDATUM]" /></td></tr>
  <tr><td>Abholdatum:</td><td><input type="text" size="8" id="abholdatum" name="abholdatum" value="[ABHOLDATUM]" /></td></tr>
...
&nbsp;<input type="submit" value="Nicht als Go! Paket versenden" name="anders">&nbsp;
