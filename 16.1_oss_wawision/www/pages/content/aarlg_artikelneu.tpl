...
[LIEFERSCHEINIF]
[LIEFERSCHEINELSE]
<tr><td width="170">Preis (netto):</td><td width="180"><input type="text" id="preis"  class="0"
    name="preis"  value="[PREIS]"  size="20"
    maxlength=""  ></td><td width="20">&nbsp;</td><td width="150">Erm&auml;&szlig;igte Umsatzsteuer:</td><td width="170"><input type="checkbox" name="umsatzsteuerklasse" value="1" [UMSATZSTEUERKLASSE]>
    </td></tr>
[LIEFERSCHEINENDIF]
<tr><td width="170">Lagerartikel:</td><td width="180"><input type="checkbox" name="lagerartikel" value="1" [LAGERARTIKEL]>
    </td><td width="20">&nbsp;</td><td width="150"></td><td width="170">
    </td></tr>



 <tr><td>Artikelbeschreibung (DE):</td><td colspan="4"><textarea rows="2" id="kurztext_de" class=""
