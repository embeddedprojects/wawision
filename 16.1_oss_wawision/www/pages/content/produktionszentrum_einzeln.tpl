...
<input type="button" onclick="window.location.href='index.php?module=produktion&action=pdf&id=$id'" value="St&uuml;ckliste als Etiketten drucken" style="width:300px"><br>
<input type="button" onclick="window.location.href='index.php?module=produktion&action=pdf&id=$id'" value="Alle Artikelaufkleber drucken" style="width:300px"><br>
<!--<input type="button" onclick="window.location.href='index.php?module=produktion&action=pdf&id=$id'" value="Alle Seriennummernaufkleber drucken" style="width:300px"><br>-->
<br>
