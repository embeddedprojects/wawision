...
$result = $result[0];
  ...
  {
    $sql = "INSERT INTO etiketten (id,name,xml,bemerkung,ausblenden,verwendenals,labelbreite,labelhoehe,labelabstand,labeloffsetx,labeloffsety,format,manuell)
      VALUES('','{$this->name}','{$this->xml}','{$this->bemerkung}','{$this->ausblenden}','{$this->verwendenals}','{$this->labelbreite}','{$this->labelhoehe}','{$this->labelabstand}','{$this->labeloffsetx}','{$this->labeloffsety}','{$this->format}','{$this->manuell}')"; 
