...
$result = $result[0];
  ...
  {
    $sql = "INSERT INTO lager_platz (id,lager,kurzbezeichnung,bemerkung,projekt,firma,geloescht,logdatei,autolagersperre,verbrauchslager,sperrlager,laenge,breite,hoehe)
      VALUES('','{$this->lager}','{$this->kurzbezeichnung}','{$this->bemerkung}','{$this->projekt}','{$this->firma}','{$this->geloescht}','{$this->logdatei}','{$this->autolagersperre}','{$this->verbrauchslager}','{$this->sperrlager}','{$this->laenge}','{$this->breite}','{$this->hoehe}')"; 
