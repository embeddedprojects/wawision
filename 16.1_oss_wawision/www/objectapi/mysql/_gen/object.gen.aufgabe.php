...
$result = $result[0];
  ...
  {
    $sql = "INSERT INTO aufgabe (id,adresse,aufgabe,beschreibung,prio,projekt,kostenstelle,initiator,angelegt_am,startdatum,startzeit,intervall_tage,stunden,abgabe_bis,abgeschlossen,abgeschlossen_am,sonstiges,bearbeiter,logdatei,startseite,oeffentlich,emailerinnerung,emailerinnerung_tage,note_x,note_y,note_z,note_color,pinwand,vorankuendigung,status,ganztags,zeiterfassung_pflicht,zeiterfassung_abrechnung,kunde,pinwand_id,sort,abgabe_bis_zeit,email_gesendet_vorankuendigung,email_gesendet)
      VALUES('','{$this->adresse}','{$this->aufgabe}','{$this->beschreibung}','{$this->prio}','{$this->projekt}','{$this->kostenstelle}','{$this->initiator}','{$this->angelegt_am}','{$this->startdatum}','{$this->startzeit}','{$this->intervall_tage}','{$this->stunden}','{$this->abgabe_bis}','{$this->abgeschlossen}','{$this->abgeschlossen_am}','{$this->sonstiges}','{$this->bearbeiter}','{$this->logdatei}','{$this->startseite}','{$this->oeffentlich}','{$this->emailerinnerung}','{$this->emailerinnerung_tage}','{$this->note_x}','{$this->note_y}','{$this->note_z}','{$this->note_color}','{$this->pinwand}','{$this->vorankuendigung}','{$this->status}','{$this->ganztags}','{$this->zeiterfassung_pflicht}','{$this->zeiterfassung_abrechnung}','{$this->kunde}','{$this->pinwand_id}','{$this->sort}','{$this->abgabe_bis_zeit}','{$this->email_gesendet_vorankuendigung}','{$this->email_gesendet}')"; 
